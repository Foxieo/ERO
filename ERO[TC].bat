@echo off
title ERO[TC] - ELDEN RING The Convergence
color 0A
mode con: cols=80 lines=30
setlocal EnableDelayedExpansion

set "CONFIG_FILE=EROTC_config.txt"
set "GAME_PATH="
set "LAUNCH_BAT=Start_Convergence.bat"

echo ========================================
echo        ELDEN RING OPTIMIZED [TC]
echo ========================================
echo.
...
:get_path
echo Please select the folder containing the "Start_Convergence.bat" file using the file dialog box...
echo.
